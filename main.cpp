...
int main (int argc, char **argv) 
{
    ...
    cout << "O fluxo máximo é " << grafo->fordFulkerson(0, 5) << endl;
    ...
    // vector<int> grafoClique = grafo->EncontraClique();

    // cout << "Clique máximo encontrado: ";
    // for (int v : grafoClique ) {
    //     cout << v << " ";
    // }
    // cout << endl;

    // cout << "Número de cliques: " << grafo->ContaCliques();
}
